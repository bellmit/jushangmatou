package com.tem.gettogether.view.powerfulrecyclerview;
...
public class DividerDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public DividerDecoration(Context context, int orientation, int color, int dividerSize, int marginStart, int marginEnd) {
     ...
     * @param dividerSize     分割线大小
     */
    public DividerDecoration(Context context, int orientation, Drawable dividerDrawable, int dividerSize, int marginStart, int marginEnd) {
        if (orientation != LinearLayoutManager.VERTICAL && orientation != LinearLayoutManager.HORIZONTAL) {
            throw new IllegalArgumentException("Orientation is invalidate");
        }
    ...
    private void drawVertical(Canvas canvas, RecyclerView parent) {
        int left = parent.getPaddingStart() + mmarginStart;
        int right = parent.getMeasuredWidth() - parent.getPaddingEnd() - mmarginEnd;
