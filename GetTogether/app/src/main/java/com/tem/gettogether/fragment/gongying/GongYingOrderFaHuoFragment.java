...
public class GongYingOrderFaHuoFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction("GONGYING_ORDER_FAHUO_DATA");
        //注册广播接收
    ...
    public class MyReceiver01 extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("GONGYING_ORDER_FAHUO_DATA".equals(action)) {
                Log.d("chenshichun","========GONGYING_ORDER_FAHUO_DATA===");
                initDatas(1, false, false);
            }
        }
    }
