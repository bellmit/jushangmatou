package com.tem.gettogether.view.pull;
...
public class PullLoadMoreRecyclerView extends LinearLayout {
    ...
    public void smoll(int art) {
        if (mRecyclerView != null)
            mRecyclerView.smoothScrollToPosition(art);
    }
...
//    public void addToHo(int  i){
//        RecyclerViewHeader header = RecyclerViewHeader.fromXml(mContext,i);
//        header.attachTo(mRecyclerView);
////        mRecyclerView.addHeaderView(R.layout.layout_list_header);
