...
/**
 * 只有当targetSdkVersion >= 23时才需要权限申请
...
public class PermissionUtils {
    ...
    private static final String[] ntalkerPermissions = {
            PERMISSION_READ_PHONE_STATE,
            PERMISSION_RECORD_AUDIO,
            PERMISSION_WRITE_EXTERNAL_STORAGE,
            PERMISSION_READ_EXTERNAL_STORAGE,
...
//        }
        ...
        try {
            ...
            UiUtils.toast("please open this permission");
...
//            AndroidUtils.showToastMsg(activity_distributor_rz, "opened:" + requestPermissions[requestCode]);
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        if (notGranted.size() == 0) {
            UiUtils.toast("all permission success" + notGranted);
 ...
 */
    public static void requestMultiPermissions(final Activity activity, PermissionGrant grant) {
        ...
        final List<String> permissionsList = getNoGrantedPermission(activity, false,ntalkerPermissions);
        final List<String> shouldRationalePermissionsList = getNoGrantedPermission(activity, true,ntalkerPermissions);
 ...
 */
    public static void requestPermissionsResult(final Activity activity, final int requestCode, @NonNull String[] permissions,
        ...
        if (requestCode < 0 || requestCode >= requestPermissions.length) {
            ...
            UiUtils.toast( "illegal requestCode:" + requestCode);
            return;
        }
    ...
    public static ArrayList<String> getNoGrantedPermission(Activity activity, boolean isShouldRationale, String[] requestPermissions) {
        ...
        for (int i = 0; i < requestPermissions.length; i++) {
            ...
            try {
                ...
                UiUtils.toast( "please open those permission");
                Log.e(TAG, "RuntimeException:" + e.getMessage());
                return null;
            }
