...
public class MarqueeView extends ViewFlipper {
    ...
    private View createView(int position) {
        ...
        CircularImage ivMarquee = (CircularImage) view.findViewById(R.id.img_iv);
        TextView tvName = (TextView) view.findViewById(R.id.name_tv);
        TextView tvDetail = (TextView) view.findViewById(R.id.tv_detail);

        tvName.setText(marquee.getTitle());
        tvDetail.setText(marquee.getDetail());
        if (isImage) {
