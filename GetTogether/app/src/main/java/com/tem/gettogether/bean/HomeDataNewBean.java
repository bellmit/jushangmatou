...
public class HomeDataNewBean {
    ...
    public static class ResultEntity {
        ...
        private List<Special_recommendEntity> special_recommend;

        public List<Special_recommendEntity> getSpecial_recommend() {
            return special_recommend;
        }

        public void setSpecial_recommend(List<Special_recommendEntity> special_recommend) {
        ...
        public class Special_recommendEntity{
            private String goods_id;
            private String cover_image;
