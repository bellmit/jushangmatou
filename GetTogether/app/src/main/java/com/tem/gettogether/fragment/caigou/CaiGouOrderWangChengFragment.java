...
public class CaiGouOrderWangChengFragment extends BaseFragment {
    ...
    public static CaiGouOrderWangChengFragment getInstance(int tab) {
        CaiGouOrderWangChengFragment fragment = new CaiGouOrderWangChengFragment();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction("WANGCHENG_ORDER_REFRESH_DATA");
        //注册广播接收
    ...
    public class MyReceiver01 extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("WANGCHENG_ORDER_REFRESH_DATA".equals(action)) {
                Log.d("chenshichun","=======WANGCHENG_ORDER_REFRESH_DATA====");
