...
public class CaiGouOrderJieKuanFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
      ...
      IntentFilter filter = new IntentFilter();
        filter.addAction("JIEKUAN_ORDER_REFRESH_DATA");
        //注册广播接收
    ...
    public class MyReceiver01 extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("JIEKUAN_ORDER_REFRESH_DATA".equals(action)) {
                Log.d("chenshichun","======JIEKUAN_ORDER_REFRESH_DATA=====");
                    initDatas(1, false, false);
            }
        }
    }
