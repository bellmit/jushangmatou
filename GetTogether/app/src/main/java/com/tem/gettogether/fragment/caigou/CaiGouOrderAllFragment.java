...
public class CaiGouOrderAllFragment extends BaseFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        filter.addAction("ALL_ORDER_REFRESH_DATA");
        //注册广播接收
    ...
    public class MyReceiver01 extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if ("ALL_ORDER_REFRESH_DATA".equals(action)) {
                Log.d("chenshichun","========ALL_ORDER_REFRESH_DATA===");
                    initDatas(1, false, false);
            }
        }
    }
