...
import com.jsmt.developer.fragment.SCShopFragment;
import com.jsmt.developer.fragment.SCShoppingFragment;
...
public class SCconnectActivity extends BaseActivity {
    ...
    private SCShopFragment shopDPFragment;
        ...
        if (savedInstanceState != null) {
            ...
            switch (type) {
                case NICKNAME_TYPE:
                    ...
                    baseFragment = SCShoppingFragment.newInstance();
                    break;
                case BIRTHDAY_TYPE:
                    ...
                    baseFragment = SCShopFragment.newInstance();
                    break;
            }
        }
    ...
    protected void initData() {
        tv_title.setText(R.string.shoucangjia);
    ...
    private void getEvent(View view) {
        switch (view.getId()) {
            ...
            case R.id.ll_title:
                ...
                tv_dianp.setTextColor(getResources().getColor(R.color.text3));
                line2.setBackgroundColor(getResources().getColor(R.color.white));
                turnToFragment(baseFragment.getClass(), SCShoppingFragment.class, null);
            ...
            case R.id.ll_title2:
                ...
                line1.setBackgroundColor(getResources().getColor(R.color.white));
                line2.setBackgroundColor(getResources().getColor(R.color.home_red));
                turnToFragment(baseFragment.getClass(), SCShopFragment.class, null);
